                ...
                return (
                    <div key={activityDay.date} className="space-y-2.5">
                        <div className="flex gap-2 items-baseline">
                            <span className="text-xl text-zinc-300 font-semibold">Dia {format(activityDay.date, 'd')}</span>
                            <span className="text-xs text-zinc-500">{format(activityDay.date, 'EEEE', {locale: ptBR})}</span>
                        </div>
